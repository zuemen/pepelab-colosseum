...
export const sessions: Catalog['sessions'] = {
  ...
  baseAccount: {
    ...
    readFailed: 'Could not read this account from Base Sepolia. Reload the page to try again.',
    rejected: 'You declined the request in your wallet. Nothing was sent.',
    badHours: 'Set "Valid for (hours)" above to a positive number of hours first.',
